...
test_file_storage.py'])
    ...
    def test_new(self):
        ...
        storage = file_storage.FileStorage()
        save = file_storage.FileStorage._FileStorage__objects
        ...
        file_storage.FileStorage._FileStorage__objects = save
    ...
    def test_save(self):
        ...
        save = file_storage.FileStorage._FileStorage__objects
        file_storage.FileStorage._FileStorage__objects = new_dict
        storage.save()
        file_storage.FileStorage._FileStorage__objects = save
